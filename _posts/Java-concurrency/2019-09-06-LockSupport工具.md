...
category: Java并发
title: Java并发系列（13）LockSupport工具
tags:
- 阿里云
- 双十一
- 阿里云优惠券
...
# 1. LockSupport简介 #
在之前介绍[AQS的底层实现](http://www.guan2ye.com/2019/08/31/深入理解AbstractQueuedSynchronizer(AQS).html)，
已经在介绍java中的Lock时，比如[ReentrantLock](http://www.guan2ye.com/2019/08/31/彻底理解ReentrantLock.html),
[ReentReadWriteLocks](http://www.guan2ye.com/2019/08/31/深入理解读写锁ReentrantReadWriteLock.html),
已经在介绍线程间等待/通知机制使用的[Condition](http://www.guan2ye.com/2019/08/31/详解Condition的await和signal等待通知机制.html)
