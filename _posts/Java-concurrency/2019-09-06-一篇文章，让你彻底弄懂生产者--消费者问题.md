...
也就是说wait--->await，notify---->Signal。另外，[关于lock中condition消息通知的原理解析可以看这篇文章。](http://www.guan2ye.com/2019/08/31/详解Condition的await和signal等待通知机制.html)
